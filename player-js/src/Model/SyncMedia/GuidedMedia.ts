...
import GuidedDescription from './GuidedDescription';

/**
 * Implements:
 * https://github.com/readium/architecture/tree/sync-media/models/sync-media
 */
export default class GuidedMedia {
  @JsonProperty('description')
  @JsonType(GuidedDescription)
  public description?: GuidedDescription;
  ...
  @JsonElementType(GuidedMedia)
  public children?: GuidedMedia[];
