...
@customElement('sync-media-player')
export default class SyncMediaPlayer extends LitElement {
  @property()
  ...
  private _renderBook() {
    const syncManifestUrl = `/divian/books/nofret-gravroeverne/sync-manifest.json`;

    return html`<sync-media-navigator
      id="syncMedia"
